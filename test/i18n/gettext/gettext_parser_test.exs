defmodule I18n.Gettext.GettextParserTest do
  ...
  test "parse file - 1" do
    # This test fails although equality between te two expressions holds outside the test...
    file = """
    ...
    expected = [
      %I18n.Message{
        ...
        flag: "icu-format",
        hash: <<117, 3, 121, 64, 117, 236, 16, 108, 239, 4, 237, 29, 54, 110, 157, 16, 60,
          147, 171>>,
        line: 24,
        module: nil,
        previous_hash: nil,
